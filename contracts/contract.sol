...
contract DataObject{
     ...
     */
    constructor(bytes32 daNa, string memory intro, address pro, address dAuth) public{
        dataName = daNa;
        introduction = intro;
        provider = pro;
        dataAuth = dAuth;
     ...
     * set the data type
     */
    function setDataType(bytes32 t_key, bytes32 t_value, address td) public{
...
contract TaskObject is DataObject{
     ...
     */
    function TaskObject(bytes32 daNa, string memory intro, address pro, address dAuth) DataObject(daNa, intro, pro, dAuth) public{
     ...
     */
    function isTaskStatusFinished() view public returns(bool){
     ...
     * ending the task
     */
    function endTask() public returns(bool){
        if(msg.sender != dataAuth) return;
...
contract TypeObject{
    ...
    function TypeObject(bytes32 tyNa) public{
        typeName = tyNa;
        creator = msg.sender;
    }
     ...
     * add data set
     */
    function addDataSet(address dataSet) public{
     ...
     * add task set
     */
    function addTaskSet(address taskSet) public{
        if(msg.sender != creator) return;
...
contract TypeManagement{
    ...
    function TypeManagement() public{
        creator = msg.sender;
    }

    //add the type
    function addType(bytes32 type_level1, bytes32 type_level2) public{
    ...
    function isTypeExist(bytes32 type_level1, bytes32 type_level2) view public returns(bool){
        return types[type_level1][type_level2]!=nullAddress;
    }

    //add data to type
    function addDataToType(bytes32 type_key, bytes32 type_value, address dataAddress) public{
        if(msg.sender != creator) return;
     ...
     //add task to type
    function addTaskToType(bytes32 type_key, bytes32 type_value, address taskAddress) public{
        if(msg.sender != creator) return;
        //if the type not exsit, create it
        if(!isTypeExist(type_key, type_value)){
            addType(type_key, type_value);
...
contract DataRegister{
     ...
     */
    function addData(bytes32 daNa, string memory intro, address provider) checkAuth() public returns(address){
        //if not exist
     ...
     */
    function addTask(bytes32 taNa, string memory intro, address provider) checkAuth() public returns(address){
        //if not exist
     ...
     */
    function isDataNameExist(bytes32 dataName)  view public returns(bool){
     ...
     */
    function isTaskNameExist(bytes32 taskName) view public returns(bool){
     ...
     */
    function getDataByIndex(uint index) view public returns(address){
     ...
     */
    function getTaskByIndex(uint index) view public returns(address){
...
contract RequestObject{
     ...
     */
    function RequestObject(address req, string memory info) public{
     ...
     */
    function updateInformation(string memory info) isAuth public{
        information = info;
    }
}
...
contract DataAccessObject{
    ...
    function DataAccessObject(address pro, address dataM, string memory cap_accessT, bytes32 cap_pwd) public {
        provider = pro;
     ...
     */
    function getCapability(bytes32 requestT) view public returns(string memory){
     ...
     */
     function setCapability(bytes32 cap_pwd, string memory cap) public isDataManagement{
     ...
     */
    function isRequestExist(address requester) view  public returns(bool){
      ...
      */
      function isRequestConfirm(address requester) view public  returns(bool){
          return accessList[requestList[requester]] == accessType.Confirm;
      }
      /**
      * Check if the request is reject
      */
      function isRequestReject(address requester)  view public returns(bool){
     ...
     * Add request to list
     */
    function addRequest(address requester, bytes32 requestT, string memory information) isDataManagement  public returns(bool){
     ...
     * Confirm the request
     */
    function confirmRequest(address requester) isDataManagement public returns(bool){
        //if not exist, return
     ...
     * Reject the request
     */
    function rejectRequest(address requester) isDataManagement public  returns(bool){
         //if not exist, return
        if(!isRequestExist(requester)) return false;
    ...
    function updateRequestInfo(address requester, string memory info) isDataManagement public returns(bool){
        //if not exist, return
        if(!isRequestExist(requester)) return false;
...
contract AccessManagement{
    ...
    */
    function isDataAccessExist(bytes32 dataName) view  public returns(bool){
    ...
    */
    function isTaskAccessExist(bytes32 taskName) view public returns(bool){
     ...
     */
    function isRequestDataNameExist(address requester, bytes32 daNa) view  public returns(bool){
        //search the list
     ...
     */
    function isRequestTaskNameExist(address requester, bytes32 taNa) view public  returns(bool){
        //search the list
    ...
    */
    function createDataAccess(bytes32 dataName, address provider, string memory capability, bytes32 cap_pwd) public returns(bool){
    ...
    * Create data access object
    */
    function createTaskAccess(bytes32 taskName, address provider, string memory capability, bytes32 cap_pwd) public returns(bool){
     ...
     */
     function requestDataAccess(bytes32 dataName, address requester) public returns(bool){
     ...
     */
     function requestTaskAccess(bytes32 taskName, address requester) public  returns(bool){
...
contract UserRegister{
     ...
     */
    function addUser(address userAddress, bytes32 userName) public returns(bool){
     ...
     */
     function isNameExist(bytes32 name) view public returns(bool){
      ...
      */
     function isAddressExist(address adr) view public returns(bool){
...
contract DataShareManagement{
    ...
    function DataShareManagement() public payable{
    ...
    //Send Ether to User
    function chargeToUser(address userAddress, uint etherNum) public returns(bool){
     ...
     */
    function registerUser(bytes32 userName) public returns(bool){
        return userRegister.addUser(msg.sender, userName);
    }
     /**
     * if the name has be used, return ture, else return false
     */
    function isUserNameExist(bytes32 userName) view public  returns(bool){
        return userRegister.isNameExist(userName);
    }
    /**
      * if the address has be used, return ture, else return false
      */
     function isUserAddressExist(address adr) view public returns(bool){
      ...
      */
     function getUserNameByAddress(address adr) view public returns(bytes32){
      ...
      */
     function getUserAddressByName(bytes32 userName) view public returns(address){
      ...
      */
       ...
       */
       function getUserNameByIndex(uint index) view public  returns(bytes32){
      ...
      */
     function createData(bytes32 daNa, string memory intro, string memory cap, bytes32 cap_pwd) isTheUserRegister public returns(address){
         //create data object
      ...
      */
     function createTask(bytes32 taNa, string memory intro, string memory cap, bytes32 cap_pwd) isTheUserRegister public returns(address){
         //create task object
      ...
      */
     function isDataNameExist(bytes32 daNa) view public returns(bool){
      ...
      */
     function isTaskNameExist(bytes32 taNa) view public returns(bool){
      ...
      * add type to data
      */
     function addTypeToData(bytes32 type_key, bytes32 type_value, bytes32 dataName) isTheUserRegister public {
      ...
      * add type to task
      */
     function addTypeToTask(bytes32 type_key, bytes32 type_value, bytes32 taskName) isTheUserRegister public {
      ...
      */
      function getDataNum() view public returns(uint){
          return dataRegister.dataNum();
      }
     /**
      * Return the number of all task
      */
      function getTaskNum() view public  returns(uint){
       ...
       */
      function getDataAddressByIndex(uint index) view public returns(address){
       ...
       */
      function getTaskAddressByIndex(uint index) view public returns(address){
       ...
       */
      function getDataAddressByDataName(bytes32 dataName) view public returns(address){
          return dataRegister.dataSets(dataName);
      }
      /**
       * Get the task address by name
       */
      function getTaskAddressByTaskName(bytes32 taskName) view public returns(address){
       ...
       */
       function getDataNameByIndex(uint index) view public returns(bytes32){
           if(index >= getDataNum()) return;
       ...
       */
       function getTaskNameByIndex(uint index) view public returns(bytes32){
           if(index >= getTaskNum()) return;
      ...
      /**
        ...
        */
        function getTypeAddressByName(bytes32 type_key, bytes32 type_value) view public returns(address){
         ...
         */
          ...
          */
          function getDataAccessByName(bytes32 dataName) view public returns(address){
              return accessManagement.dataAccessList(dataName);
          }
          /**
          * Return the task access object
          */
          function getTaskAccessByName(bytes32 taskName) view public returns(address){
              return accessManagement.taskAccessList(taskName);
          }
          /**
           * Get the provider data number by provider address
           */
          function getDataNumByProvider(address provider) view public returns(uint){
              return accessManagement.provideDataNum(provider);
          }
          /**
           * Get the provider task number by provider address
           */
          function getTaskNumByProvider(address provider) view public returns(uint){
           ...
           */
          function getProvideDataNameByIndex(address provider, uint index) view public returns(bytes32){
           ...
           */
          function getProvideTaskNameByIndex(address provider, uint index) view public returns(bytes32){
           ...
           */
          function getDataNumByRequester(address requester) view public returns(uint){
           ...
           */
          function getTaskNumByRequester(address requester) view public returns(uint){
           ...
           */
          function getRequestDataNameByIndex(address requester, uint index) view public returns(bytes32){
           ...
           */
          function getRequestTaskNameByIndex(address requester, uint index) view public returns(bytes32){
              return accessManagement.requestTaskList(requester, index);
          }
          /**
           * Check the task is finished or not
           */
           function isTaskFinished(bytes32 taskName) view public returns(bool){
           ...
           */
          function requestData(bytes32 dataName, bytes32 requestT, string memory information) isTheUserRegister public returns(bool){
           ...
           */
          function requestTask(bytes32 taskName, bytes32 requestT, string memory information) isTheUserRegister public returns(bool){
           ...
           */
          function rejectData(bytes32 dataName, address requester) isTheUserRegister public returns(bool){
              if(!isDataNameExist(dataName)) return false;
              DataAccessObject accessObject = (DataAccessObject)(getDataAccessByName(dataName));
           ...
           */
          function rejectTask(bytes32 taskName, address requester) isTheUserRegister public returns(bool){
              if(!isTaskNameExist(taskName)) return false;
              DataAccessObject accessObject = (DataAccessObject)(getTaskAccessByName(taskName));
              //if the sender not the data provider
              if(msg.sender != accessObject.provider()) return false;
           ...
           */
          function confirmData(bytes32 dataName, address requester) isTheUserRegister public returns(bool){
              if(!isDataNameExist(dataName)) return false;
              DataAccessObject accessObject = (DataAccessObject)(getDataAccessByName(dataName));
              //if the sender not the data provider
              if(msg.sender != accessObject.provider()) return false;
           ...
           */
          function confirmTask(bytes32 taskName, address requester) isTheUserRegister public  returns(bool){
              if(!isTaskNameExist(taskName)) return false;
              DataAccessObject accessObject = (DataAccessObject)(getTaskAccessByName(taskName));
              //if the sender not the data provider
              if(msg.sender != accessObject.provider()) return false;
           ...
           */
          function changeDataRequestInfo(bytes32 dataName, string memory info) isTheUserRegister public returns(bool){
           ...
           */
          function changeTaskRequestInfo(bytes32 taskName, string memory info) isTheUserRegister  public returns(bool){
               if(!isTaskNameExist(taskName)) return false;
              DataAccessObject accessObject = (DataAccessObject)(getTaskAccessByName(taskName));
              //check if the accessObject exist and requester exist
              if(accessObject == initAddress || !accessObject.isRequestExist(msg.sender)) return false;
           ...
           */
           function getDataRequest(bytes32 dataName, address requester) view public returns(address){
           ...
           */
           function getTaskRequest(bytes32 taskName, address requester) view  public  returns(address){
            ...
            */
            function endTask(bytes32 taskName) public returns(bool){
                TaskObject taskObject = (TaskObject)(getTaskAddressByTaskName(taskName));
              ...
              * Set data capability
              */
              function setDataCapability(bytes32 dataName, bytes32 cap_pwd, string memory cap) public returns(bool){
                  DataAccessObject accessObject = (DataAccessObject)(getDataAccessByName(dataName));
